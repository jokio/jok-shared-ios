...
namespace Jok.Shared {
	public class InAppPurchaseManager : SKProductsRequestDelegate {
		...
		public static Action<string, bool> Done {get;set;}
		public static Action ProductsReceived {get;set;}
...
*/
		...
		public void FinishTransaction(SKPaymentTransaction transaction, bool wasSuccessful)
		{
			...
			if (Done != null)
				Done (transaction.Payment.ProductIdentifier, wasSuccessful); 
		}
